...
class ScheduleController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $schedule->bus_id_type= $request->bus_id_type;
    ...
    public function update(Request $request, $id)
    {
        ...
        if (isset($request->bus_code)) {
            $schedule->bus_code= $request->bus_code;
        }

        if (isset($request->bus_id_type)) {
            $schedule->bus_id_type = $request->bus_id_type;
        }

        if (isset($request->initial_route)) {
            $schedule->initial_route = $request->initial_route;
        }

        if (isset($request->destination_route)) {
            $schedule->destination_route = $request->destination_route;
        }
        ...
        if (isset($request->seat_total)) {
            $schedule->seat_total = $request->seat_total;
        }

        if (isset($request->seat_available)) {
            $schedule->seat_available = $request->seat_available;
        }
        */
    }
