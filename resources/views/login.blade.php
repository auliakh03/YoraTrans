                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row justify-content-center align-items-center">
                            ...
                            <div class="col-lg-6 d-flex flex-column align-items-center justify-content-center text-center">
                                <img src="{{ asset('Admin/img/yoraTrans.jpg') }}" alt="Yora Trans Logo"  class="img-fluid" 
                                style="max-width: 200px; display: block; margin: 0 auto; border-radius: 50%;">

                                <div class="p-5 w-100">
                                    <h1 class="h4 text-gray-900 mb-4">Welcome Yora Trans</h1>
                                    @if($errors->any())
                                    ...
                                    @endif
                                    <form class="user w-100" action="/" method="POST" >
                                        @csrf
